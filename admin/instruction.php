...
LangFile::loadMessages(__FILE__, 'AMMINA_STOPVIRUS_INSTRUCTION');
...
////////////////////////////
$sTabID = 'ammina_stopvirus_instruction';
$pageLinkList = '/bitrix/admin/ammina.stopvirus.attempts.php';
$pageLinkEdit = '/bitrix/admin/ammina.stopvirus.instruction.php';
