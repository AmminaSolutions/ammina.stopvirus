...
LangFile::loadMessages(__FILE__, 'AMMINA_STOPVIRUS_RECOMMENDATION');
...
////////////////////////////
$sTabID = 'ammina_stopvirus_recommendation';
$pageLinkList = '/bitrix/admin/ammina.stopvirus.attempts.php';
$pageLinkEdit = '/bitrix/admin/ammina.stopvirus.recommendation.php';
